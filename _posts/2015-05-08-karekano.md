...
At some point, I've had three different sets of DVDs downloaded:
R1 relese, Spanish, and homemade Russian.
...
Now, downloading the R1 release turned out to be somehow problematic.
At the time I tried to do it, in 2010, there were no seeds in any of
Kare Kano R1 torrents.  I could not even find it on some closed trackers.
...
I tried fixing this issue using various blending plugins and
writing a plugin on my own, but I failed reverse this problem.
...
I inspected at all individual frames in the first episode
and down blending parameters for all required frames.
...
please send an email to [m1el.2027@gmail.com](m1el.2027@gmail.com).
